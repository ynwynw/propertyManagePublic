...
public class ShebeizujieEntity<T> implements Serializable {
	private static final long serialVersionUID = 1L;


	public ShebeizujieEntity() {
		
	}
	
	public ShebeizujieEntity(T t) {
		try {
	 ...
	 * 设置：租借原因
	 */
	public void setZujieyuanyin(String zujieyuanyin) {
		this.zujieyuanyin = zujieyuanyin;
	}
	/**
	 * 获取：租借原因
	 */
	public String getZujieyuanyin() {
		return zujieyuanyin;
	}
	/**
	 * 设置：业主账号
