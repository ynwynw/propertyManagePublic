...
<div id="pageHeader">
    <div class="menu-switch">
        <iconfont icon="el-icon-s-fold" v-if="!isCollapse.value" @click.native="window.isCollapse.value=true"></iconfont>
        <iconfont icon="el-icon-s-unfold" v-else @click.native="window.isCollapse.value=false"></iconfont>
    </div>
    ...
    <el-dropdown >
        <div class="user-avatar">
            <img v-if="userInfo.value && userInfo.value.touxiang" :src="userInfo.value.touxiang"/>
